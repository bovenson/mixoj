...
class HtmlDownloader(object):
    ...
    def download(url):
        if url is None:
            return None
        user_agents = [{'User-Agent': 'Mozilla/5.0 (Windows NT 6.1; WOW64; rv:5.0) Gecko/20100101 Firefox/5.0'},
        ...
        req = urllib.request.Request(url, None, random.choice(user_agents))
